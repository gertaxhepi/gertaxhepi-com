...
export function ContactBlock() {
  return (
    <section className="container-page pt-16 md:pt-20 pb-6 md:pb-8">
      <Reveal>
        <div
          data-reveal-item
          className="text-[11px] font-mono uppercase tracking-[0.22em] text-muted-foreground mb-8"
        >
          Contact
        </div>
        <h2
      ...
      <Reveal className="mt-12 md:mt-14 grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-10">
        {channels.map((c) => (

...
function About() {
  return (
    <>
      ...
      <Section spacing="tight">
        <div className="mb-7 text-[11px] font-mono uppercase tracking-[0.18em] text-terracotta">
          Beyond Work
        </div>
        ...
        <div className="beyond-work-grid mt-12 md:mt-16">
          {beyondWorkActivities.map((activity) => (
            <article key={activity.number} className="beyond-work-item">
              <img src={activity.image} alt={activity.alt} className="beyond-work-image" loading="lazy" />
              <div className="mt-6 grid grid-cols-[2.5rem_minmax(0,1fr)] gap-x-4 md:mt-7">
                <span className="font-mono text-xs text-terracotta" aria-hidden="true">{activity.number}</span>
                <div className="min-w-0">
